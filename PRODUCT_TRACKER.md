...
| Current phase | Phase 6 persistence/security — F-030 server-side authorization built at library level (Slices 1a–1c + request enforcement glue); route wiring deferred to Phase 5/F-024; Phase 4 F-023 awaiting live QA |
...
| Unit/component | `pnpm test` | PASS | 2026-08-03 | 49/49 Node tests (config/render/route/geography/stories/auth/rbac/server-session/authz/require-authorization) | — |
