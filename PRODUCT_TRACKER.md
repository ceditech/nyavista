...
| Tests | PASS — 20/20 Node tests and 94/94 isolated Playwright visual/interaction tests (2026-08-02); Auth Emulator integration command added but execution pending |
...
| F-023 | S2 | P4 | Authentication and onboarding | P0 | IN_PROGRESS | 60% | VALIDATE | Codex | Slice 1 manually accepted; live Firebase client configured locally and verified without creating users; emulator harness retained; live auth flow, emulator integration, server-session, deletion, and onboarding evidence pending | CRITICAL | F-010, Firebase Authentication enablement |
...
- Status / owner: IN_PROGRESS (60%) / Codex
...
- Next approval/unblock: manually exercise live registration, email verification, sign-in, recovery, and denial states after confirming Email/Password is enabled in Firebase Authentication. The Auth Emulator integration command exists but its execution remains pending. Do not begin F-024 or treat client identity as authorization.
